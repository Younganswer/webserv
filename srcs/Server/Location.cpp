...
Location::Location(void): _root(""), _alias(""), _autoindex(""), _return_status(""), _return_url("") {}
Location::Location(const Config::map &config_map, size_t idx): _root(_parseRoot(config_map, idx)), _alias(_parseAlias(config_map, idx)), _autoindex(_parseAutoIndex(config_map, idx)), _return_status(_parseReturnStatus(config_map, idx)), _return_url(_parseReturnUrl(config_map, idx)) {}
Location::Location(const Location &ref): _root(ref._root), _alias(ref._alias), _autoindex(ref._autoindex), _return_status(ref._return_status), _return_url(ref._return_url) {}
